...
const data = [
  ...
  { Species: 'I. setosa', type: 'PetalWidth', value: 0.2, _bin: [0.1, 0.2, 0.2, 0.3, 0.6] ,outliers:[5] },
  ...
  { Species: 'I. versicolor', type: 'PetalWidth', value: 1.4, _bin: [1, 1.2, 1.3, 1.5, 1.8] ,outliers:[4] },
  ...
  { Species: 'I. virginica', type: 'PetalWidth', value: 2.5, _bin: [1.4, 1.8, 2, 2.3, 2.5],outliers:[3] }
];
...
describe('box outliers', () => {
  it('with groupField', () => {
    ...
    const geometry = box.chart.views[0].geometries[0];
